...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="categoryid" id = "txt_search_categoryid">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveContent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>广告标题：</td>
								<td><input type="text" id="username" name="contenttitle"
							...
							<tr>
								<td>广告分类：</td>
								<td colspan="2">
									<select class="form-control" name="categoryid" id = "roleid" aria-required="true" required>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            categoryid: $("#txt_search_categoryid").val(),
	...
	function initEditUser(getSelection){
		...
		$('#roleid').val(getSelection.categoryid);
		$('#username').val(getSelection.contenttitle);
